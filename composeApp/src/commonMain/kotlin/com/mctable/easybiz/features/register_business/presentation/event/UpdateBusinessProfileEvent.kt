...
sealed class UpdateBusinessProfileEvent {
    data class LoadBusiness(val id: String) : UpdateBusinessProfileEvent()
    data class UpdateBusiness(val id: String) : UpdateBusinessProfileEvent()
    data class NavigateToMedia(val id: String) : UpdateBusinessProfileEvent()
    ...
    data class WorkingHoursChanged(val hours: String) : UpdateBusinessProfileEvent()
